...
## The Headline Unemployment Rate looks
...
## The Economy is lagging behind its potential
...
```{r message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, fig.fullwidth = TRUE, fig.cap = "Series ID: A939RX0Q048SBEA, BEA Account Code: A939RX0"}
  ggplot(HL_long, aes(x = date, y = Dollars)) +
        ...
        scale_y_continuous(position = "right") +
         xlab("Year") +
         ylab("2009 Dollars") +
         labs(subtitle = "Potential Computed by Hamilton-Leff Approach") + 
...
[\textcolor{blue}{Github Repository}](https://github.com/JustinMShea)


```{r, out.width = "90%"}
image_path <- paste0(path.expand("~/R/ruAmericanDream/image/Github_image.png"))
