...
## Corporate Profits, Percentage of Cash Flows
...
```{r message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, fig.fullwidth = TRUE, fig.cap = "Real Minimum Wage, in 2009 Dollars"}
...
ggplot(data=discrim, aes(x=emp, y=wagest, col = NJ)) + 
        geom_point() +
        theme_bw()

ggplot(data=discrim, aes(x=emp2, y=wagest2, col = NJ)) + 
        geom_point() +
        theme_bw()
